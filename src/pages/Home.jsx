  ...
  return (
    <div className="flex flex-col-reverse items-center justify-between gap-8 p-6 sm:flex-row sm:gap-16 sm:p-16 bg-white dark:bg-gray-900">
      ...
      <div className="max-w-lg text-center sm:text-left">
        ...
        <p className="mt-4 text-lg text-gray-700 dark:text-gray-300 sm:text-xl md:text-2xl lg:text-3xl transition-transform transform duration-1000 delay-300 ease-out opacity-0 animate-slide-in">
          Stay updated with live crypto prices. Check out the dashboard now!
        </p>
       ...
       {/* Image Section */}
       <div className="relative w-auto h-[80vh] sm:h-[90vh]">
        <img
          src={gradient}
          alt="Gradient Background"
          className="absolute top-10 left-10 w-[90%] h-[90%] opacity-50 dark:opacity-30"
        />
        <img
          src={iphone}
          alt="iPhone"
