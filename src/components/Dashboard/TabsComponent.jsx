  ...
  return (
    <div className="my-4 sm:my-6 w-full">
      ...
      <div className="border-b border-gray-300 dark:border-gray-700 flex flex-wrap">
        <button
          className={`py-2 px-4 text-sm font-semibold flex-1 ${tab === "grid" ? "text-blue-500 border-b-2 border-blue-500" : "text-gray-500 dark:text-gray-300"}`}
          onClick={() => handleTabChange("grid")}
        >
          Grid
        </button>
        <button
          className={`py-2 px-4 text-sm font-semibold flex-1 ${tab === "list" ? "text-blue-500 border-b-2 border-blue-500" : "text-gray-500 dark:text-gray-300"}`}
